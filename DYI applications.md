...
- FieldAI Mapping and Humble Robotics were prepared or screened but replaced before submission; they remain manual follow-up candidates only if still open and still desirable.
...
- `manual submit needed`: user action is required before submission can be completed.

## Update Rules

- Keep this file limited to applications Codex did not complete.
- Preserve the same table columns as `application_tracker.md`.
- Include the original job posting URL for every row.
